...
from computer_module.runner import run_computer_task  # noqa: E402
from computer_module.store import create_computer_task, get_computer_task, list_computer_events  # noqa: E402
...
async def main():
    ...
    task_id = create_computer_task(
        USER, CHAT_SESSION_ID, "write /home/user/hello.py containing print('hello world'), run it, verify the output"
    )
